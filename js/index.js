...
var question_1 = 'Пусто'
var question_2 = 'Пусто'
var question_3 = 'Пусто'
var question_4 = 'Пусто'
var question_5 = 'Пусто'
var question_6 = 'Пусто'
var question_7 = 'Пусто'
var question_8 = 'Пусто'
var question_9 = 'Пусто'
var question_10 = 'Пусто'
var fio = 'Пусто'
var phone = 'Пусто'
var price = 'Пусто'
var kupon = 'Пусто'
...
jQuery(window).scroll(function () {
  ...
  // jQuery('#line').hide(500)
  // jQuery('#menublock').addClass('animatemenu')
  // }else{
  // jQuery('#menublock').removeClass('animatemenu')
  // jQuery('#line').show(500)
  // }


  if (windowScrollTop > 250) {
    jQuery('#top').css({ 'backgroundColor': 'rgba(83, 51, 237, 0.8)' })
  }
  else {
    jQuery('#top').css({ 'backgroundColor': 'rgba(83, 51, 237, 0)' })
...
// Перемотка после показа нового слайда
...
if (mul == 1) {
  jQuery('.mul').html('интернет магазинов в Москве!')
}

if (mul == 2) {
  jQuery('.mul').html('интернет магазинов в Красноярске!')
}
...
//Активируем иконку при выборе и кладем выбранный пункт в переменную
jQuery('.questions_step1').click(function () {
  ...
  if (jQuery(this).find('span')[0]) {
    price_item = jQuery(this).find('span')[0].innerText;
  }
...
jQuery('#btn4').on('click', function () {
  ...
  var variant1 = jQuery('#variant1').val()
  ...
  if (logic) {
    ...
    console.log('В массиве: ' + JSON.stringify(question_4))

    logic = false
    myarr = []
    return false
  } else {
    jQuery('#error').html('Выберите один из вариантов или напишите свой!')
    jQuery('#modal-1').modal()
    return false
  }
...
jQuery('#btn5').on('click', function () {
  ...
  if (logic) {
    ...
    console.log('В массиве111: ' + JSON.stringify(question_5))
...
jQuery('#btn6').on('click', function () {
  ...
  if (logic) {
    ...
    console.log('В массиве: ' + JSON.stringify(question_6))
...
jQuery('#btn8').on('click', function () {
  ...
  var variant4 = jQuery('#variant4').val()
...
jQuery('#btn9').on('click', function () {
  ...
  if (logic) {
    ...
    jQuery('.kupon-price').html(question_9)
    ...
    jQuery('#error').html('Выберите один из вариантов!')
    jQuery('#modal-1').modal()
    return false
  }
...
jQuery('#btn10').on('click', function () {
  ...
  if (logic) {
    ...
    console.log('В последнем массиве: ' + question_10)

    if (question_10 == 'WhatsApp') {
      jQuery('#phone-1').attr("placeholder", "Ваш WhatsApp")
    }

    if (question_10 == 'Telegram') {
      jQuery('#phone-1').attr("placeholder", "Ваш Telegram")
    }

    if (question_10 == 'Viber') {
      jQuery('#phone-1').attr("placeholder", "Ваш Viber")
    }

    if (question_10 == 'E-mail') {
      jQuery('#phone-1').attr("placeholder", "Ваш E-mail")
    }
...
jQuery('#btn11').on('click', function () {


  phone = jQuery('#phone-1').val();
  fio = jQuery('#name-1').val();

  console.log('Итоговые данные: ' + accarr)
  ...
  if (phone.length > 5) {
    ...
    var msg = {
      ...
      question9: JSON.stringify(question_9),
      question10: JSON.stringify(question_10),
      fio: fio,
      phone: phone,
      dataset: dataset
    }
